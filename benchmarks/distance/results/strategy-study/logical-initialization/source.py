...
def main(output, seconds, seed):
    ...
    atomic_json(
        output / "metadata.json",
        {
            ...
            "scope": "One-seed initialization diagnostic; polishing uses an uninstrumented full slice and reports returned bounds",
            "warning": "Representative-span enumeration is not full quantum-distance enumeration; stabilizer variants are omitted",
